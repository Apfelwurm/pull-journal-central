    ...
    <AppLayout title="Organisations">
        ...
        <template #header>
            <h2 class="flex justify-between text-xl font-semibold leading-tight text-gray-800">
                ...
                <inertia-link href="organisations/create">
                    <a
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                            ...
                            <div class="relative flex items-stretch w-4/5 mb-3 input-group">
                                ...
                                <button
                                    ...
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="search"
                                        class="w-4" organisation="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <caption style="display: none;">Organisations listing</caption>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="organisation in organisations.data" :key="organisation.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-center text-gray-900">
                                        <inertia-link class="transition hover:text-blue-500" :href="`organisations/${organisation.id}`">{{
                                            organisation.name }}</inertia-link>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-center text-gray-900">
                                        <span
                                            ...
                                            {{ organisation.formatted_created_at }}
                                        </span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    <inertia-link :href="`/organisations/${organisation.id}/edit`"
                                    ...
                                    <a href="#" @click="deleteOrganisation(organisation)"
                    ...
                    <Pagination class="mt-6" :links="organisations.meta.links" :term="term" />
                </div>
            </div>
        </div>
    </AppLayout>
...
watch(term, debounce(() => {
	router.get(route('organisations.index'), {term: state.term}, {preserveState: true, preserveScroll: true, only: ['organisations']})
}, 300));
...
const deleteOrganisation = (organisation) => {
  if (!confirm('Are you sure want to delete organisation?')) return;
